...
const Order = sequelize.define('Order', {
  ...
  status: {
    type: DataTypes.ENUM('pending', 'assigned', 'processing', 'shipped', 'delivered', 'cancelled'),
    defaultValue: 'pending',
  },
  production_status: {
    type: DataTypes.ENUM('order_received', 'started', 'in_progress', 'ready_to_dispatch'),
  ...
  order_type: { type: DataTypes.ENUM('B2B', 'B2C'), defaultValue: 'B2C' },
